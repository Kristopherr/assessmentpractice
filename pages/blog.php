...
$blog=$conn->prepare("SELECT id, title, created_at, content, status FROM blogs Where status ='published'");
$blog->execute();
$blog->store_result();
$blog->bind_result($blogId, $blogTitle, $blogCreatedAt, $blogContent, $status);
