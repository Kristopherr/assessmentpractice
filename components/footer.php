...
<footer class="p-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com" class="hover:underline" target="_blank">Chrizim™</a>. All Rights Reserved.
</span>
...
<p class="mt-5"> Maroon 5 and Justin Bieber Fan club LTD <a class="text-blue-600 hover:underline"
        href="https://flowbite.com/docs/getting-started/introduction/" target="_blank">NotAVirus</a>.
</p>
</div>
</body>
</html>